...
import Bordered from "../../../../components/common/bordered/bordered";
import ImageCropperDialog from "../../../../components/common/image-cropper-dialog/image-cropper-dialog";
...
function AddPostOptions(props: any) {
  const {
    Dropzone,
    classes,
    files,
...
export default withStyles(styles as {}, { withTheme: true })(AddPostOptions);
